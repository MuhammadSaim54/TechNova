...
function CTASection() {
  ...
  return (
    <Section id="cta" className="py-16 sm:py-20 md:py-28 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          {/* Atmospheric Dual Glowing Energy Orbs */}
          <motion.div 
            aria-hidden="true" 
            animate={{
              scale: [1, 1.15, 1],
          ...
          <div className="relative z-20 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 lg:gap-14">
            ...
            <div className="flex flex-col items-start text-left max-w-2xl">
              ...
              {/* Eyebrow Badge with Real-Time Telemetry Ping */}
