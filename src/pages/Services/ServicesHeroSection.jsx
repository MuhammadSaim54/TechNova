...
import { Sparkles, Code2, Layers, Cpu, Globe, Rocket } from "lucide-react";
...
const SERVICE_CAPABILITIES = [
  ...
  { label: "Cloud & DevOps", icon: Globe },
  { label: "AI Integration", icon: Cpu },
  { label: "Growth Architecture", icon: Rocket },
];

// Interactive Micro-Chip with Spring Physics
function CapabilityChip({ label, icon: Icon }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          We architect, design, and engineer resilient digital solutions. From enterprise platforms to bespoke high-converting products, we help modern brands scale with precision.
        </motion.p>

        {/* Interactive Capability Dock */}
        <motion.div 
          variants={heroChildVariants}
