...
import { Sparkles, Code2, PenTool, Cloud, Cpu, Lightbulb } from "lucide-react";
...
const TOPIC_CHIPS = [
  ...
  { label: "AI Frontier", icon: Cpu },
  { label: "Tech Strategy", icon: Lightbulb },
];

// Interactive Micro-Chip with Spring Physics
function TopicChip({ label, icon: Icon }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Interactive Topic Capabilities Dock */}
        <motion.div 
          variants={heroChildVariants}
