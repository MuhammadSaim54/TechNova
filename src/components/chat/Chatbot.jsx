      ...
      {!isOpen && (
        <button
          ...
          className="
            ...
            hover:shadow-[0_12px_45px_rgba(0,81,251,0.45)] dark:hover:shadow-[0_12px_45px_rgba(0,81,251,0.65)]
        ...
        >
          ...
          <TechNovaMark className="h-7 w-7 transition-transform duration-300 group-hover:scale-110 text-primary dark:text-cyan-300" />
      ...
      {isOpen && (
        <div
          ...
          className="
            ...
            backdrop-blur-2xl
            shadow-[0_20px_50px_rgba(0,0,0,0.15)] dark:shadow-[0_25px_80px_rgba(0,0,0,0.85),0_0_0_1px_rgba(255,255,255,0.06)]
            overflow-hidden
